...
class App {
    ...
    constructor() {
        ...
        //Creating the list of employees and storing in an array
        this.employees = [];
    ...
    nextEmployee() {
        inquirer.prompt(this.employeePrompt).then(data => {
            ...
            //allows for creation of a new employee or to exit
        });
    }

    //Writes the rendered html to output folder
    renderHTML() {
    ...
    getScript() {
        ...
        this.employees.forEach(e => {
            ...
            var cardText2 = $('<a href="https://mail.google.com/mail/u/0/#inbox?compose=new"><p class="card-text"><br>');
            cardText2.text("Email: ${e.getEmail()}");
            if("${e.getRole()}" === "Engineer"){
                var cardText3 = $('<br/><a href="https://github.com/"><p class="card-text">');
